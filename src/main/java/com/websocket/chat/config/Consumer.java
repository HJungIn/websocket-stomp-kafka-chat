...
//    }
    public void consume(ChatMessage message){
        log.info("CONSUME PAYLOAD : " + message.getSender()+":"+message.getMessage());
        try{
//            messagingTemplate.setMessageConverter(new StringMessageConverter());
//            messagingTemplate.convertAndSend("/sub/chat/room/" + message.getRoomId(), message.getSender() + "|" + message.getRoomId() + ":" + message.getMessage() + " / " +message.getTimestamp());
